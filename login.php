...
if (isset($_POST['loginsubmit'])) {
  if (isset($_POST['email']) && isset($_POST['pw'])) {
    ...
    if( mysqli_num_rows($qry_result)>0 ){
        ...
        exit(); // add exit() after redirect to terminate script execution
    } else {
...
} // close the if statement for isset($_POST['email']) && isset($_POST['pw'])
  ...
  <div style="width: 100%">
    ...
    <?php echo "<script> showAlert('$errormsg') </script>"; ?>
      ...
      <h4> Login to your existing account</h4>
            ...
            <input type class="forminput" value="<?php echo $email; ?>" name="email" id="email" onkeypress="isNotChar(event)" required>
            ...
            <br>
            <a href="#" id="gotosignup"> test---Don't have an account? Create a new account now</a>
            </form>
